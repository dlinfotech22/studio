      ...
      <header>
        ...
        <p className="text-muted-foreground">
          {userRole === 'system_admin'
            ? 'Esta seção é para usuários de empresas gerenciarem seu catálogo de serviços.'
            : 'Adicione, edite e gerencie os serviços que sua empresa oferece.'}
        </p>
      </header>
      {userRole === 'system_admin' ? (
        <div className="flex flex-1 items-center justify-center rounded-lg border border-dashed shadow-sm p-8 text-center h-[400px]">
          <div className="flex flex-col items-center gap-2">
            ...
            <p className="max-w-md mt-2 text-sm text-muted-foreground">
              A tela de catálogo de serviços é utilizada para gerenciar os itens de uma empresa específica. Como administrador do sistema, seu foco está na gestão de empresas e usuários globais.
            </p>
          </div>
        </div>
      ) : (
